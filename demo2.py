...
def train_model():
    ...
    x = Dropout(0.5)(x)
    x = Dense(1024, activation="relu")(x)
    predictions = Dense(4, activation="softmax")(x)  # set to num of classes we have
    ...
    checkpoint = ModelCheckpoint("final_model.h5", monitor='val_acc', verbose=1, save_best_only=True,
